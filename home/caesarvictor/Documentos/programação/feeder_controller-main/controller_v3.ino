...
void action(void *pvParameters) {
  for (;;) {
    ...
    if (currentLine.endsWith("GET /LM")) {  //engine on
      if (kg < MaxKg) {
        digitalWrite(22, HIGH);
        digitalWrite(23, LOW);
        while (kg < MaxKg) {
    ...
    if (currentLine.endsWith("GET /DM")) {  //engine off
      digitalWrite(23, LOW);
      digitalWrite(22, LOW);
    }
    if (currentLine.endsWith("GET /LB")) {  //pump on
      if (distancia < nvlMax) {
        digitalWrite(18, HIGH);
        digitalWrite(19, LOW);
    ...
    if (currentLine.endsWith("GET /DB")) {  //pump off
      digitalWrite(18, LOW);
      digitalWrite(19, LOW);
    }
  }
